...
import com.neu.account.dao.AuthDao;
import com.neu.account.entity.TAuth;
import com.neu.account.entity.Message;
import com.neu.account.util.HttpUtil;
import com.neu.account.util.IPUtil;
...
public class AuthServiceImpl implements AuthService {
    ...
    public Message getAuthInfo(String authToken, String userId, boolean isScan) {
        TAuth auth = authDao.getAuthInfo(authToken);
        // 为空则获取信息失败
        if (auth == null) {
            return new Message(201, "获取口令信息失败", new TAuth());
        }
